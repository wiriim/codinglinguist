...
Route::post('/edit-profile', [UserController::class, 'editProfile'])->name('edit-profile-post');
...
Route::get('/posts/filter/{programmingLanguage}/{postType}/{sortBy}/{search}', [ForumController::class,'filterPosts'])->name('posts-filter-search');

Route::get('/create-post', [ForumController::class, 'getCreatePostPage'])->name('post-create');
Route::post('/create-post', [ForumController::class, 'createPost'])->name('post-create-post');

Route::get('/edit-posts/{post}', [ForumController::class,'getEditPostPage'])->name('post-edit');
Route::post('/edit-posts/{post}', [ForumController::class,'editPost'])->name('post-edit-post');
