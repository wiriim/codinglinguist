<div class="compiler-container mt-5 w-100 d-flex flex-column">
    ...
    <p>
        ...
        <ul class="note-list d-none">
            ...
            <li>If you are coding Java, remember to import any necessary package. e.g; <code>import java.util.Scanner</code></li>
            <li>If you are coding Java, remember to wrap your code in a <code>public Class Main</code> & <code>public static void main(String[] args)</code></li>
        </ul>
    </p>
